...
@section('content')
                ...
                <div class="col-md-12 order-2 order-md-1">
                    <div class="card-body">
                        <div class="panel-body">
                            ...
                            <p>SIAMEL (Sistem Informasi Anggaran Monitoring Evaluasi dan Pelaporan) adalah sebuah
                                aplikasi
                                berbasis web yang dikembangkan oleh BIDANG PERENCANAAN, PENGENDALIAN DAN EVALUASI
                            ...
                            <p>Dikembangkan dan dikelola secara mandiri oleh BIDANG PERENCANAAN, PENGENDALIAN DAN EVALUASI
                                PEMBANGUNAN DAERAH BAPPLITBANGDA KAB. BARTIM dengan tujuan mempermudah Perangkat Daerah se
                                Kabupaten Barito Timur untuk melakukan pelaporan Realisasi Anggaran perbulannya</p>
    ...
    <div class="col-xxl-6 col-md-12">
        <div class="card h-100">
            <iframe width="100%" height="315" src="https://www.youtube.com/embed/prUvYhx8-nE?si=c3e_5QTjxuMo3nbE"
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-text-secondary rounded-pill text-muted border-0 p-1" type="button"
                                    id="totalTransaction" data-bs-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                ...
                <ul class="p-0 m-0">
                    <li class="d-flex align-items-center mb-6">
                        <div class="avatar avatar-md flex-shrink-0 me-4">
                            <div class="avatar-initial bg-light-gray rounded-3">
                                <div>
                                    <img src="{{ url('/') }}assets/img/icons/misc/3d-illustration.png" alt="User"
                                        class="h-25" />
                                </div>
                            </div>
                        </div>
                    ...
                    <li class="d-flex align-items-center mb-6">
                        <div class="avatar avatar-md flex-shrink-0 me-4">
                            <div class="avatar-initial bg-light-gray rounded-3">
                                <div>
                                    <img src="{{ url('/') }}assets/img/icons/misc/finance-app-design.png"
                                        alt="User" class="h-25" />
                                </div>
                            </div>
                        </div>
                    ...
                    <li class="d-flex align-items-center mb-6">
                        <div class="avatar avatar-md flex-shrink-0 me-4">
                            <div class="avatar-initial bg-light-gray rounded-3">
                                <div>
                                    <img src="{{ url('/') }}assets/img/icons/misc/4-square.png" alt="User"
                                        class="h-25" />
                                </div>
                            </div>
                        </div>
                    ...
                    <li class="d-flex align-items-center mb-6">
                        <div class="avatar avatar-md flex-shrink-0 me-4">
                            <div class="avatar-initial bg-light-gray rounded-3">
                                <div>
                                    <img src="{{ url('/') }}assets/img/icons/misc/delta-web-app.png" alt="User"
                                        class="h-25" />
                                </div>
                            </div>
                        </div>
                    ...
                    <li class="d-flex align-items-center">
                        <div class="avatar avatar-md flex-shrink-0 me-4">
                            <div class="avatar-initial bg-light-gray rounded-3">
                                <div>
                                    <img src="{{ url('/') }}assets/img/icons/misc/ecommerce-website.png"
                                        alt="User" class="h-25" />
                                </div>
                            </div>
                        </div>
        ...
        <div class="card h-100">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-text-secondary rounded-pill text-muted border-0 p-1" type="button"
                            id="salesCountryDropdown" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <i class="ri-more-2-line ri-20px"></i>
                        </button>
                ...
                <ul class="nav nav-tabs nav-tabs-widget pb-6 gap-4 mx-1 d-flex flex-nowrap" role="tablist">
                    <li class="nav-item">
                        <a href="javascript:void(0);"
                            ...
                            <div class="avatar avatar-sm">
                                <img src="{{ url('/') }}assets/img/icons/brands/google.png" alt="User" />
                            </div>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="javascript:void(0);"
                            ...
                            <div class="avatar avatar-sm">
                                <img src="{{ url('/') }}assets/img/icons/brands/facebook-rounded.png"
                                    alt="User" />
                            </div>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="javascript:void(0);"
                            ...
                            <div class="avatar avatar-sm">
                                <img src="{{ url('/') }}assets/img/icons/brands/instagram-rounded.png"
                                    alt="User" />
                            </div>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="javascript:void(0);"
                            ...
                            <div class="avatar avatar-sm">
                                <img src="{{ url('/') }}assets/img/icons/brands/reddit-rounded.png" alt="User" />
                            </div>
                        </a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="card h-100">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-text-secondary rounded-pill text-muted border-0 p-1" type="button"
                            id="weeklySalesDropdown" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <i class="ri-more-2-line ri-20px"></i>
                        </button>
        ...
        <div class="card h-100">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-text-secondary rounded-pill text-muted border-0 p-1" type="button"
                            id="visitsByDayDropdown" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <i class="ri-more-2-line ri-20px"></i>
                        </button>
                        ...
                        <div class="timeline-event">
                            ...
                            <div class="d-flex align-items-center mb-1">
                                <div class="badge bg-lighter rounded-3">
                                    <img src="{{ url('/') }}assets//img/icons/misc/pdf.png" alt="img"
                                        width="15" class="me-2" />
                            ...
                            <div class="d-flex justify-content-between flex-wrap gap-2">
                                <div class="d-flex flex-wrap align-items-center">
                                    <div class="avatar avatar-sm me-2">
                                        <img src="{{ url('/') }}assets/img/avatars/1.png" alt="Avatar"
                                        ...
                                        <ul
                                            ...
                                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                ...
                                                <img class="rounded-circle"
                                                    src="{{ url('/') }}assets/img/avatars/5.png" alt="Avatar" />
                                            </li>
                                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                data-bs-placement="top" title="Allen Rieske" class="avatar pull-up">
                                                <img class="rounded-circle"
                                                    src="{{ url('/') }}assets/img/avatars/12.png" alt="Avatar" />
                                            </li>
                                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                data-bs-placement="top" title="Julee Rossignol" class="avatar pull-up">
                                                <img class="rounded-circle"
                                                    src="{{ url('/') }}assets/img/avatars/6.png" alt="Avatar" />
                                            </li>
                                            <li class="avatar">
