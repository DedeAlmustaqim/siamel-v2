...
<body>
    ...
    <table border="1" width="100%" cellpadding="2" class="text_utama">
        ...
        <tr class="text-tr">
            ...
            <td class="text-right"><?php echo rupiah($total->jml_pg_50); ?></td>
            <td class="text-center"><?php echo $total->pl_pkt_50; ?></td>
            <td class="text-right"><?php echo rupiah($total->pl_rp_50); ?></td>
            <td class="text-center"><?php echo $total->h_pl_pkt_50; ?></td>
            <td class="text-right"><?php echo rupiah($total->h_pl_rp_50); ?></td>
            <td class="text-center"><?php echo $total->kontrak_pkt_50; ?></td>
            <td class="text-right"><?php echo rupiah($total->kontrak_rp_50); ?></td>
            <td class="text-center"><?php echo $total->st_pkt_50; ?></td>
            <td class="text-right"><?php echo rupiah($total->st_rp_50); ?></td>
            <td class="text-center"><?php echo $total->bp_pkt_50; ?></td>
            <td class="text-right"><?php echo rupiah($total->bp_rp_50); ?></td>
        </tr>
