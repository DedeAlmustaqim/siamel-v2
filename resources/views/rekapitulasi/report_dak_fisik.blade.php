...
<body>
    ...
    @php
        ...
        $bln = $id_bln;
    @endphp
    <h2 class="text-center">TABEL REALISASI DANA ALOKASI KHUSUS ( DAK ) FISIK REGULER {{ $pemda->pemda }}</h2>
    ...
    <table width="100%" class="table table-bordered" border="1" cellpadding="5" cellspacing="5">
        ...
        <tr>
            ...
            <td class="text-right"><?php echo rupiah($u->mek_nilai_swa); ?></td>
        ...
        <tr>
            ...
            <td class="text-right"><b><?php echo rupiah($sum->pagu); ?></b></td>
            <td class="text-right"></td>
            <td class="text-right"></b></td>
            <td class="text-right"></td>
            <td class="text-right"></td>
            <td class="text-right"></td>
            <td class="text-right"><b><?php echo rupiah($sum->real_keu); ?></b></td>
            <td class="text-right"><b><?php echo number_format($sum->real_keu_per, 2, ',', ' '); ?></b></td>

            <td class="text-right"><b><?php echo number_format($sum->real_fik, 2, ',', ' '); ?><b></td>
            <td></td>
        </tr>
